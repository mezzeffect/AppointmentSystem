...
class HomePage extends React.Component {
    ...
    render() {
        ...
        return (<div>
                ...
                <FilterForm onChange={this.updateSearchState} onFilter={this.applyFilter} search={this.state.search}/>

                <OpportunitiesList activePageNum={this.state.activePage} allItems={this.state.allItems} itemsPerPage={this.state.itemsPerPage} pageList={this.state.currentList} onPaginate={this.handleSelect} allItemsCount={this.state.allItemsCount}/>
            </div>);
    }
}
