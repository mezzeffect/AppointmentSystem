...
import { EditOpportunityForm } from '../../components/editOpportunity'
import { getAppointmentById as getOpportunityById, clearCurrentAppointment as clearCurrentOpportunity } from '../../actions'
const s: any = require('./opportunity.component.css')

class EditOpportunity extends React.Component<any, any> {
